...
import { createProductRules, updateProductRules, idParamRule } from "../validation/product.validation.js";
...
router.put("/:id", protect, authorize("admin"), uploadProductImages, idParamRule, updateProductRules, validate, productController.updateProduct);
